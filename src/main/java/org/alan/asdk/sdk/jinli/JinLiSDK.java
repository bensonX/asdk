package org.alan.asdk.sdk.jinli;

import org.alan.asdk.common.Log;
import org.alan.asdk.entity.UChannel;
import org.alan.asdk.entity.UOrder;
import org.alan.asdk.entity.UUser;
import org.alan.asdk.sdk.jinli.jinli.JinLiBase64;
import org.alan.asdk.sdk.jinli.jinli.RSASignature;
...
public class JinLiSDK implements ISDKScript {
    ...
    public void verify(final UChannel channel, String extension, final ISDKVerifyListener callback) {
        ...
        try {
            ...
            httpClient.post(channel.getMaster().getAuthUrl(), headers, new ByteArrayEntity(token.getBytes(Charset.forName("UTF-8"))), new UHttpCallback() {
                @Override
    ...
    public void onGetOrderID(UUser user, final UOrder order, final ISDKOrderListener callback) {
        ...
        try {
            ...
            UHttpAgent.getInstance().post(order.getChannel().getMaster().getOrderUrl(), headers, new ByteArrayEntity(data.toString().getBytes(Charset.forName("UTF-8"))), new UHttpCallback() {
                @Override
