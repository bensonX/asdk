 ...
 * @param <PK>
 */
public class UHibernateTemplate<T, PK extends Serializable> implements IHibernateTemplate<T, PK> {
    ...
    public Object findUnique(String sql, Object... params) {
        return createQuery(sql, params).setMaxResults(1).uniqueResult();
    }
