...
public class OppoPayCallbackAction extends UActionSupport {
    ...
    public void payCallback() {
        try {
            Log.i("<oppo>充值回调开始： notifyId=" +notifyId+ ", partnerOrder=" +partnerOrder+ ", productName=" +productName+ ", productDesc=" +productDesc+
            ", price=" +price+ ", count=" +count+ ", attach=" +attach+ ", sign=" +sign);
            ...
            if (order.getState() == PayState.STATE_COMPLETE) {
                Log.d("<oppo>订单完成状态：" + order.getState());
