...
public class VivoPayCallbackAction extends UActionSupport {
    ...
    public void payCallback() {
        try {
            Log.i("<vivo>充值回调开始： respCode=" +respCode+ ", respMsg=" +respMsg+ ", signMethod=" +signMethod+ ", signature=" +signature+ ", tradeType=" +tradeType+ ", tradeStatus=" +tradeStatus+ ", cpId=" +cpId+ ", appId=" +appId+ ", uid=" +uid+ ", cpOrderNumber=" +cpOrderNumber+ ", orderNumber=" +orderNumber+ ", orderAmount=" +orderAmount+ ", extInfo=" +extInfo+ ", payTime=" +payTime);
            ...
            if (order.getState() == PayState.STATE_COMPLETE) {
                Log.d("<vivo>订单完成状态：" + order.getState());
