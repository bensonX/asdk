...
!function ($) {
    ...
    BootstrapTable.DEFAULTS = {
        ...
        sidePagination: 'client', // client or com.u8.server
        totalRows: 0, // com.u8.server side need to set
        pageNumber: 1,
        pageSize: 10,
    ...
    BootstrapTable.prototype.initData = function (data, type) {
        ...
        if (this.options.sidePagination === 'com.u8.server') {
            return;
        }
        this.initSort();
    };
    ...
    BootstrapTable.prototype.initBody = function (fixedScroll) {
        ...
        if (!this.options.pagination || this.options.sidePagination === 'com.u8.server') {
            this.pageFrom = 1;
